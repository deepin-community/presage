...
void Presage::learn(const std::string text)
{
...
std::string Presage::context ()
{
    return contextTracker->getPastStream();
}

bool Presage::context_change ()
{
    return contextTracker->contextChange();
}

std::string Presage::prefix ()
{
    return contextTracker->getPrefix();
}

std::string Presage::config (const std::string variable)
{
